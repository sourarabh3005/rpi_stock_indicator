...
import time
import queue
from gpio_ref import GpioThread  # Import GpioThread from thread.py
from stock_ref import StockThread, TASK_1, TASK_2  # Import StockThread and tasks from thread2.py
